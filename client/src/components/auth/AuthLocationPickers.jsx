...
function PickerTrigger({ label, value, placeholder, disabled, onClick }) {
  return (
...
export default function AuthLocationPickers({
  value,
  onChange,
  ...
  return (
    <>
      ...
      {cityMode === 'other' && (
        <div className="auth-field">
          <label htmlFor="auth-custom-city">City name</label>
          <input
            id="auth-custom-city"
